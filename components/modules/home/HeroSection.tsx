...
export default function HeroSection() {
    return (
        <section className="w-full min-h-screen flex flex-col px-8 py-16">
            <h1 className="text-6xl md:text-7xl font-bold text-gray-900 leading-tight">Reuse, Reduce, Recycle</h1>
            ...
            <div className="w-full flex flex-col md:flex-row items-center justify-between gap-8 mt-12">
                <div className="w-full md:w-[40%] flex flex-col gap-6">
                    <Button className="w-1/2 py-5 bg-transparent text-green-600 border border-green-400 rounded-xl text-lg hover:bg-green-50 transition cursor-pointer">
                        Talk to us
                    </Button>
                    <div className="w-full h-64 bg-[url('/hero-1.jpg')] bg-cover bg-center rounded-2xl shadow-md"></div>
                </div>

                <div className="w-full md:w-[60%] h-80 bg-[url('/hero-1.jpg')] bg-cover bg-center rounded-2xl shadow-md"></div>
            </div>
        </section>
    );
}